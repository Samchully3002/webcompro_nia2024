        ...
        <!-- <div class="imx"> -->
                ...
                <div class="footer3blok">
                    ...
                    <div class="blok">
                        <div>
                            ...
                            <ul>
                                <li><a class="btn" href="/about-us">{{ __ ('footer-about')}}</a></li>
                                <li><a class="btn" href="/community/notice">{{ __ ('footer-notice')}}</a></li>
                                <li><a class="btn" href="/community/news">{{ __ ('footer-news')}}</a></li>
                                <li><a class="btn" href="https://www.youtube.com/@networksindonesiaaku4258" target="_blank" rel="noopener">{{ __ ('footer-videos')}}</a></li>
                                <li><a class="btn" href="/contact">{{ __ ('footer-contact')}}</a></li>
                            </ul>
                        </div>
                        <div>
                            <h1>{{ __ ('footer-business')}}</h1>
                            <ul>
                                <li><a class="btn" href="/intellegent-integrated-logistic">{{ __ ('iil')}}</a></li>
                                <li><a class="btn" href="/digital-healthcare">{{ __ ('dh')}}</a></li>
                                <li><a class="btn" href="/system-development-management">{{ __ ('sdm')}}</a></li>
                                <li><a class="btn" href="/export-voucher">{{ __ ('ev')}}</a></li>
                                <li><a class="btn" href="/web-design">{{ __ ('wdd')}}</a></li>
                                <li><a class="btn" href="/creative-solutions">{{ __ ('cs')}}</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="blok">
                        ...
                        <div>
                            <h3>{{ __ ('footer-hq')}}</h3>
                            <p><a class="btn" href="https://www.sclnetworks.co.kr" target="_blank" rel="noopener">https://www.sclnetworks.co.kr</a></p>
                        </div>
                        <div>
                            <h3>{{ __ ('footer-email1')}}</h3>
                            <p><a class="btn" href="mailto:info@nia.co.id" target="_blank" rel="noopener">{{ __ ('footer-email2')}}</a></p>
                        </div>
            ...
            <div class="clear layoutMobile">
                ...
                <!-- <li><a>Terms and Conditions</a></li> -->
                    <li><a class="btn" href="/privacy-policy">{{ __ ('footer-privacy') }}</a></li>
                    <!-- <li><a>Cookies</a></li> -->
                </ul>
            </div>
            <!-- recording visitor -->
